        ...
        <div >
            <div className='bg-white flex flex-col justify-between items-center rounded-2xl p-3 relative mt-3'>
                <div className="flex w-full" onClick={switch1}>
                    ...
                    <div className={`px-2 rotate-[${deg}] flex justify-center items-center`}>
                    ...
                    return (
                        <div key={v.id} className="flex flex-row w-full gap-2 pt-3">
                            ...
                            <div className="flex items-center justify-center">
                                <RadioBoxCustom group={v.group} id={v.id} key={v.id} setValue={handleSetValue} selectedOption={selectedOption} setSelectedOption={setSelectedOption} />
                            </div>
                        </div>
                    )
                })}
