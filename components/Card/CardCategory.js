...
export default function CardCategory({ link = '', title = 'เมนูโปรดของฉัน', img = '/imgs/demo/img1.webp' }) {
    return (
        <div className='justify-self-center' style={{ display: "flex", flexDirection: 'column', width: 'fit-content' }} >
            <Image src={img} alt="img1" height={0} width={0} sizes="100vw" style={{ borderRadius: "16px",width:"100%",height:"auto" }} />
