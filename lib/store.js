    ...
    persist(
        (set, get) => ({
            ...
            SetListOrderTotal: (price, count) => set(state => {
                ...
                return { ...state, BTN_addOrderActive: addOrderActive, ListOrderTotal: (price + sum) * count , count  }
            }),
            ...
            clearDataOrderListConfirm: () => set((state) => ({ ...state, DataOrderListConfirm: [] , count : 0 })),
            ...
            DiscountInfo: { PointToBaht: '0.00' },
            SetDiscountInfo: (obj) => set((state) => ({ ...state, DiscountInfo: { ...state.DiscountInfo, ...obj } })),
            resetDiscountInfo: () => set({ DiscountInfo: { PointToBaht: '0.00' } }),
            UpdateListOrder: (qty, price) => set((state) => ({
                ...state, Cart: {...state.Cart.ListOrderDetail.ListOrder, total: price, quntity: qty}
            }))
        }),
        {
